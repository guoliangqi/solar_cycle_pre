# -*- coding: utf-8 -*-
"""
Created on Tue Nov 27 15:37:59 2018
...
HIDDEN_SIZE = 18                            # LSTM中隐藏节点的个数。
NUM_LAYERS = 2                              # LSTM的层数。
TIMESTEPS = 10                              # 循环神经网络的训练序列长度。
TRAINING_STEPS = 10000                      # 训练轮数。
BATCH_SIZE = 21                             # batch大小。
TRAINING_EXAMPLES = 3115                    # 训练数据个数。
TESTING_EXAMPLES = 101                      # 测试数据个数。
SAMPLE_GAP = 0.01
...
for i in range(101):
    X2.append(b[0][3114+i: i + 3124])
    y2.append(b[0][i + 3124])
